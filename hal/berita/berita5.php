    ...
    <div class="container py-md-5 py-4">
        ...
        <div class="speak">
            <div class="row mt-lg-5 mt-4">
                <?php
                $sql = "SELECT * FROM berita where judul_berita='Krejengan - Rapat Anggota Tahunan (RAT) BUMDes' ";
                $q = mysqli_query($conn,$sql);
                while($r = mysqli_fetch_assoc($q)){
                ?>
                <div class="col-md-12 events-img">
                <img src="images/Berita_Bumdes2.jpg" class="img-fluid" alt="user-image" />
                </div>
                <div class="col-md-12 events-info my-3">
                    <h3><span class="sub-tittle">05</span> <?=$r['judul_berita']?></h3>
                    <ul class="events-icons new-inf mt-md-4 mt-3 d-flex">
                        ...
                        <li><a href="#"><span class="fa fa-folder-open mx-1"></span> Ekonomi</a></li>
                    </ul>
                </div>
                <p><?=$r['konten_detail']?></p>
                <?php } ?>
            ...
            <div class="single-form-left">
                ...
                <div class="contact-single">
                    <h3><span class="sub-tittle">05</span> Leave a Reply</h3>
            ...
            <div class="media py-5">
                <div>
                    <?php
                            $sql = "SELECT * FROM komen where no_berita='5' ";
                            $q = mysqli_query($conn,$sql);
                            while($r = mysqli_fetch_assoc($q)){
                    ?>
