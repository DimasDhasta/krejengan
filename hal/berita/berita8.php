    ...
    <div class="container py-md-5 py-4">
        ...
        <div class="speak">
            <div class="row mt-lg-5 mt-4">
                <?php
                $sql = "SELECT * FROM berita where judul_berita='Gus Zulmi Bagikan Puluhan Ton Beras' ";
                $q = mysqli_query($conn,$sql);
                while($r = mysqli_fetch_assoc($q)){
                ?>
                <div class="col-md-12 events-img">
                <img src="images/Berita_BaktiSosial2.jpg" class="img-fluid" alt="user-image" />
                </div>
                <div class="col-md-12 events-info my-3">
                    <h3><span class="sub-tittle">08</span> <?=$r['judul_berita']?></h3>
            ...
            <div class="single-form-left">
                ...
                <div class="contact-single">
                    <h3><span class="sub-tittle">08</span> Leave a Reply</h3>
            ...
            <div class="media py-5">
                <div>
                    <?php
                            $sql = "SELECT * FROM komen where no_berita='8' ";
                            $q = mysqli_query($conn,$sql);
                            while($r = mysqli_fetch_assoc($q)){
                    ?>
