    ...
    <div class="container py-md-5 py-4">
        ...
        <div class="speak">
            <div class="row mt-lg-5 mt-4">
                <?php
                $sql = "SELECT * FROM berita where judul_berita='Sosialisasi PHBS Sebagai Langkah Peningkatan Kesehatan Masyarakat' ";
                ...
                <div class="col-md-12 events-info my-3">
                    <h3><span class="sub-tittle">04</span> <?=$r['judul_berita']?></h3>
            ...
            <div class="single-form-left">
                ...
                <div class="contact-single">
                    <h3><span class="sub-tittle">04</span> Leave a Reply</h3>
            ...
            <div class="media py-5">
                <div>
                    <?php
                            $sql = "SELECT * FROM komen where no_berita='4' ";
                            $q = mysqli_query($conn,$sql);
                            while($r = mysqli_fetch_assoc($q)){
                    ?>
